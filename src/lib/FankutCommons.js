...
// Menu
// ================================================================================================================
export function FankutMenu({ githubUser }) {
    ...
    <FankutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar no Fankut" />
          </div>
        </nav>
      ...
      <FankutMenuProfileSidebar githubUser={githubUser} />
    </FankutMenu.Wrapper>
  )
}
FankutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;

  .fankutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
// FankutProfileSidebarMenuDefault
// ================================================================================================================
export function FankutProfileSidebarMenuDefault() {
  return (
    <FankutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
FankutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
